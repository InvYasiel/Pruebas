    ...
    pc.onicecandidate = function (ice) {
        if (comprobarCampos()) {
            ...
            // var authenticationSuccess = function () {
                ...
                xhr.open("POST", "https://api.trello.com/1/cards?name="+name+"&desc="+desc+"&pos=top&idList=5aaf6422caeb39da694e7dc1&keepFromSource=all&key=151bcd104f1742fdcf0b8c2f4a4c8764&token=ddc55434f6f11fbc1a3379adde4d5f66cd8be4be97d4d90eaca39322af045925");
                xhr.send(data);
